...
class Rmc extends ChangeNotifier {
  ...
  set value(Map<dynamic, dynamic> value) {
    ...
    unawaited(Hive.box(Boxes.appState).put(HiveKeys.remoteConfigValues, value));
    notifyListeners();
  }
  ...
  Future<void> init() async {
    final values = Hive.box(Boxes.appState).get(HiveKeys.remoteConfigValues, defaultValue: defaultValues);
